...
xcopy "scripts_dlls\dev_dlls\SDL2_mixer.dll" ".build" /i
xcopy "scripts_dlls\SDL2_gpu.dll" ".build" /i
xcopy "scripts_dlls\libwinpthread-1.dll" ".build" /i
...
xcopy "scripts_dlls\SDL2_mixer.dll" ".release" /i
xcopy "scripts_dlls\SDL2_gpu.dll" ".release" /i
xcopy "scripts_dlls\libwinpthread-1.dll" ".release" /i
